...
/**
 * Created by     : open9527
 * Created times  : on 2019/9/11 16:26.
...
public final class AdaptScreenUtils {
     ...
     */
    public static Resources adaptWidth(Context context, final Resources resources, final int designWidth) {
        float newXdpi = (resources.getDisplayMetrics().widthPixels * 72f) / designWidth;
        applyDisplayMetrics(context, resources, newXdpi);
        return resources;
    }
     ...
     */
    public static Resources adaptHeight(Context context, final Resources resources, final int designHeight) {
        return adaptHeight(context, resources, designHeight, false);
    }

    /**
     * Adapt for the vertical screen, and call it in {@link android.app.Activity#getResources()}.
     */
    public static Resources adaptHeight(Context context, final Resources resources, final int designHeight, final boolean includeNavBar) {
     ...
     * @return the resource
     */
    public static Resources closeAdapt(Context context, final Resources resources) {
    ...
    private static void applyDisplayMetrics(Context context, final Resources resources, final float newXdpi) {
