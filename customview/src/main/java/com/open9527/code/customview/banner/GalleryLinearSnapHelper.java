...
import com.open9527.code.customview.CustomViewUtils;

/**
 * Created by     : open9527
 * Created times  : on 2019/9/12 12:06.
...
public class GalleryLinearSnapHelper extends LinearSnapHelper {
    ...
    public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int velocityX, int velocityY) {
        ...
        CustomViewUtils.showLogInfo("GalleryLinearSnapHelper", "---hDeltaJump---" + hDeltaJump + "");
        int targetPos = currentPosition + hDeltaJump;
        if (targetPos < 0) {
            targetPos = 0;
        }
        CustomViewUtils.showLogInfo("GalleryLinearSnapHelper", "+++targetPos+++"+targetPos+"");
