package com.open9527.code.customview.textview;
...
/**
 * Created by     : open9527
 * Created times  : on 2019/9/2 13:28.
...
public class ExpandTextView extends LinearLayout {
    ...
    public ExpandTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        textColor = typedArray.getColor(R.styleable.ExpandTextView_contentTextColor, Color.BLACK);
        ...
        btnTextColor = typedArray.getColor(R.styleable.ExpandTextView_btnTextColor, Color.BLACK);
        ...
        iconRes = typedArray.getInt(R.styleable.ExpandTextView_iconRes, android.R.drawable.arrow_down_float);
