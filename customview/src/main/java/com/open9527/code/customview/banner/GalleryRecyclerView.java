...
/**
 * Created by     : open9527
 * Created times  : on 2019/9/12 11:58.
...
//                CustomViewUtils.showLogInfo("handleMessage----",cur+""+"----"+currentItem);
...
//            mSelectedPosition = getCurrentItem()+2;
            mSelectedPosition = getCurrentItem() + 1;
//            CustomViewUtils.showLogInfo("handleMessage----","----"+mSelectedPosition);
            stopPlay();
        }
