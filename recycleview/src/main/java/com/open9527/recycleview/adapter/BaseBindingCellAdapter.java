 ...
 * DESC :描述文件.
 */
public class BaseBindingCellAdapter<Item extends BaseBindingCell> extends RecyclerView.Adapter<BaseBindingCellViewHolder> {
    ...
    public int removeItem(@NonNull final Item item, boolean notifyRemoved) {
        ...
        if (itemIndex != -1) {
            ...
            notifyItemRangeChanged(itemIndex, mItems.size());
        }
        return itemIndex;
    }
