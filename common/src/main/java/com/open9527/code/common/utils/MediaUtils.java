...
import com.open9527.code.common.entity.LocalMedia;
            ...
            public List<LocalMediaFolder> doInBackground() throws Throwable {
                ...
                if (cursor != null && cursor.getCount() > 0) {
                    ...
                    do {
                        ...
                        String path = CommonUtils.checkedAndroid_Q() ? getRealPathAndroid_Q(id) : cursor.getString(cursor.getColumnIndexOrThrow(PROJECTION[1]));
