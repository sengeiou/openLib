...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerItemDecoration(Context context, int orientation, int dividerHeight, int dividerColor, int start, int end) {
        this.setOrientation(orientation);
        this.start = start;
        this.end = end;
        mDividerHeight = dividerHeight;
    ...
    private void drawHorizontal(Canvas canvas, RecyclerView parent) {
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (mPaint != null) {
                if (start > 0 || end > 0) {
                    canvas.drawRect(start, y, width - end, height, mPaint);
                } else {
                    canvas.drawRect(0, y, width, height, mPaint);
                }
    ...
    private void drawVertical(Canvas canvas, RecyclerView parent) {
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (mPaint != null) {
                if (start > 0 || end > 0) {
                    canvas.drawRect(left, top + start, right, bottom - end, mPaint);
                } else {
