...
/**
 * Created by     : open9527
 * Created times  : on 2019/11/4 13:25.
 * E-Mail Address ：open_9527@163.com.
 * DESC :描述文件.
 */
public class CenteredDialogFragment extends BaseDialogFragment {
    ...
    private CenteredDialogFragment.ViewListener mViewListener;

    public static CenteredDialogFragment create(FragmentManager manager) {
        CenteredDialogFragment dialog = new CenteredDialogFragment();
    ...
    public CenteredDialogFragment setFragmentManager(FragmentManager manager) {
        mFragmentManager = manager;
        return this;
    }

    public CenteredDialogFragment setViewListener(CenteredDialogFragment.ViewListener listener) {
        mViewListener = listener;
        return this;
    }

    public CenteredDialogFragment setLayoutRes(@LayoutRes int layoutRes) {
        mLayoutRes = layoutRes;
        return this;
    }

    public CenteredDialogFragment setCancelOutside(boolean cancel) {
        mIsCancelOutside = cancel;
        return this;
    }

    public CenteredDialogFragment setTag(String tag) {
        mTag = tag;
        return this;
    }

    public CenteredDialogFragment setDimAmount(float dim) {
        mDimAmount = dim;
        return this;
    }

    public CenteredDialogFragment setHeight(int heightPx) {
        mHeight = heightPx;
        return this;
    }
    public CenteredDialogFragment setWidth(int widthPx) {
        mWidth = widthPx;
        return this;
    }
    @Override
