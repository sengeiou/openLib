...
import com.open9527.code.image.picture.dragimageview.core.DraggableImageViewerHelper;
import com.open9527.code.image.picture.dragimageview.core.ImageInfo;
...
public class ImageListActivity extends CommonBindingActivity<ActivityImagelistBinding> {
    ...
    private void showImages(View view, int index) {
        DraggableImageViewerHelper.showImages(this, view, listUrl, index);
    }
}
