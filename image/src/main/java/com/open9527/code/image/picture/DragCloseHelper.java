package com.open9527.code.image.picture;
...
/**
 * Created by     : open9527
 * Created times  : on 2019/9/6 14:30.
    ...
    public void exitWithTranslation(float currentY) {
        ...
        anim.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                ((Activity) mContext).overridePendingTransition(R.anim.anim_empty, R.anim.anim_drag_close_out);
            }
