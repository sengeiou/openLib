...
public class PermissionFragment extends Fragment implements Runnable {
     ...
     * 回调对象存放
     */
    private final static SparseArray<IPermission> PERMISSION_ARRAY = new SparseArray<>();
     ...
     * 准备请求
     */
    public void prepareRequest(Activity activity, IPermission call) {
        // 将当前的请求码和对象添加到集合中
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        IPermission call = PERMISSION_ARRAY.get(requestCode);
     ...
     * @return
     */
    private static Random mCodeGenerator = new Random();
    ...
    private static int makeRequestCode() {
        ...
        do {
            ...
            tryCount++;
        } while (PERMISSION_ARRAY.get(requestCode) != null && tryCount < 10);
        return requestCode;
    }
}